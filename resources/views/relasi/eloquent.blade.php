    ...
    <div class="col-md-10 mx-auto">
        ...
        @foreach ($mahasiswas as $temp)
            <div class="card mb-4 border rounded-3 shadow-sm p-3">
                ...
                <div class="mt-3">
                    <ul>
                        <li>Nama Wali:<strong>{{($temp->wali)->nama ?? 'Belum ada wali' }}</strong></li>
                        <li>Dosen Pembimbing:<strong>{{($temp->dosen)->nama ?? 'Belum ada dosen'}}</strong></li>
                    </ul>
                </div>
            </div>
        @endforeach
